            ...
            <div class="">
                <a href="">
                    <div class="alert alert-success">
                        <div>
                            <h3>地址：<?php echo $result['site']?></h3>
                            <h3>电话：<?php echo $result['tel']?></h3>
                            <h3>售后：<?php echo $result['suppot']?></h3>
                            <h3>售后电话：<?php echo $result['nexttel']?></h3>
                            <h3>传真：<?php echo $result['fax']?></h3>
                            <h3>官网：<?php echo $result['home']?></h3>
                            <h3>邮箱：<?php echo $result['email']?></h3>
                        </div>
                    </div>
                </a>
            </div>
